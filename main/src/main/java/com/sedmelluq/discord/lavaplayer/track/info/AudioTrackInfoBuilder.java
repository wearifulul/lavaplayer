...
public class AudioTrackInfoBuilder implements AudioTrackInfoProvider {
  ...
  private static final String UNKNOWN_ARTWORK = "https://cdn.discordapp.com/attachments/729047083020976171/768910087913603092/a.png";
  ...
  public AudioTrackInfoBuilder setArtwork(String artwork) {
    artwork = artwork;
    return this;
  };
  ...
  public AudioTrackInfoBuilder apply(AudioTrackInfoProvider provider) {
    ...
    return setTitle(provider.getTitle())
        ...
        .setArtwork(provider.getArtwork());
  }
