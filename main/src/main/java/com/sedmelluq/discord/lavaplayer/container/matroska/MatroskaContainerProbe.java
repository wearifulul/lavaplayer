...
import static com.sedmelluq.discord.lavaplayer.container.MediaContainerDetection.UNKNOWN_ARTWORK;
...
public class MatroskaContainerProbe implements MediaContainerProbe {
  ...
  public MediaContainerDetectionResult probe(AudioReference reference, SeekableInputStream inputStream) throws IOException {
    ...
    return supportedFormat(this, null, new AudioTrackInfo(UNKNOWN_TITLE, UNKNOWN_ARTIST,
        (long) file.getDuration(), reference.identifier, false, reference.identifier, UNKNOWN_ARTWORK));
  }
